...
<p align="center"><img src="docs/demo-web-v9.gif" width="470" alt="Slothing 網頁 demo(BOOX 平板瀏覽器實錄)— 打「我用claude寫注音輸入法」:即打即轉、中英自動切換、觸控候選列、點字改字+整句重評分、上字後聯想接龍"></p>
...
<p align="center"><img src="docs/android-boox-demo-v7.gif" width="460" alt="Slothing 在 BOOX Tab Mini C(Android)上:點大千注音鍵,免選字打出「我用 claude 寫注音輸入法,很好玩。」(中英自動切換、免聲調),改字:他很漂亮 → ↓選字 → 點詞「她很」;上字後**聯想**接龍:電 → 腦 → …"></p>
