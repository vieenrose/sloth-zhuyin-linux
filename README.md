...
<p align="center"><img src="docs/android-boox-demo-v6.gif" width="460" alt="Slothing 在 BOOX Tab Mini C(Android)上:點大千注音鍵,免選字打出「我用 claude 寫注音輸入法,很好玩。」(中英自動切換、免聲調),再示範改字:他很漂亮 → ↓選字 → 點詞「她很」→ 她很漂亮"></p>
