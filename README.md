...
<p align="center"><img src="docs/demo-web-v12.gif" width="470" alt="網頁 demo(BOOX 平板實錄,11.6M 模型):打「我用claude寫注音輸入法」——整句正確免選字、中英自動切換、字/句候選、上字後聯想接龍"></p>
...
| | |
|---|---|
| **免選字整句轉換** | 微軟新注音式即打即轉;230 句免選字基準 **72%**(held-out 誠實值;舊 84% 因評測取樣自訓練語料而虛高,見 [docs/EVAL.md](docs/EVAL.md)) |
...
- 模型與完整重現流程(資料→標註→NAS→訓練→ONNX):[Luigi/slothlm-e-12m-zhuyin](https://huggingface.co/Luigi/slothlm-e-12m-zhuyin)
...
| 基準 | 分數 |
|---|---|
| 230 句免選字(整句全對,held-out)| **72%**(360/500;舊基準 84% 有洩漏 → 見 [docs/EVAL.md](docs/EVAL.md))|
