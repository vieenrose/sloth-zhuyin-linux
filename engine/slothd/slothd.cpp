// slothd: a minimal Unix-socket daemon that reranks libchewing candidate
...
// is unset. Keep this identical to slothdSocketPath() in eim.cpp and the
// derivation in packaging/run-slothd.sh.
...
int main(int argc, char ** argv) {
    ...
    if (!table_path.empty()) {
        ...
        fprintf(stderr, "slothd: decode mode on (%zu syllables, %zu toneless)\n",
    ...
    fprintf(stderr, "slothd: listening on %s\n", socket_path.c_str());
