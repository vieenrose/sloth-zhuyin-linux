...
<p align="center"><img src="docs/android-boox-demo-v6.gif" width="460" alt="Slothing on a BOOX Tab Mini C (Android): tapping Dàqiān bopomofo keys, typing 我用 claude 寫注音輸入法，很好玩。 (auto zh/en code-switch, tone-free syllables, 免選字), then adjusting a word: 他很漂亮 → ↓選字 → tap the 她很 phrase chip → 她很漂亮"></p>
