// JNI boundary for com.sloth.ime.Core. One SlothSession per IME instance
...
// SlothSession's own mutex + generation counter make that race-free — see
...
namespace {
JavaVM *g_vm = nullptr;
jclass g_preedit = nullptr;    // com.sloth.ime.Preedit
jmethodID g_preeditCtor = nullptr;
jclass g_candidates = nullptr; // com.sloth.ime.Candidates
jmethodID g_candidatesCtor = nullptr;
jclass g_phrase = nullptr;     // com.sloth.ime.Phrase
jmethodID g_phraseCtor = nullptr;
jclass g_string = nullptr;

SlothSession *sess(jlong h) { return reinterpret_cast<SlothSession *>(h); }
...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *) {
    ...
    g_preedit = pin("com/sloth/ime/Preedit");
    g_candidates = pin("com/sloth/ime/Candidates");
    g_phrase = pin("com/sloth/ime/Phrase");
...
#define JNI(ret, name) \
    JNIEXPORT ret JNICALL Java_com_sloth_ime_Core_##name
...
JNI(jlong, nativeInit)(JNIEnv *env, jobject, jstring modelPath,
    ...
    auto *s = new SlothSession(std::move(dec), tableBytes,
