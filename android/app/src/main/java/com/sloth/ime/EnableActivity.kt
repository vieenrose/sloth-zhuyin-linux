...
/**
 * Tiny launcher/settings activity. Two taps get Sloth IME usable:
 *   1. "在系統設定啟用" -> Settings.ACTION_INPUT_METHOD_SETTINGS (enable the IME),
 *   2. "切換到 Sloth IME" -> InputMethodManager.showInputMethodPicker() (select it).
...
class EnableActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // A focusable field to try Sloth IME (and to drive on-device validation).
    ...
    /** True once the user has enabled Sloth IME in Settings. */
